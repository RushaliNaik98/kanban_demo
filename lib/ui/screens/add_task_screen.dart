...
class AddTaskScreen extends StatefulWidget {
  ...
  const AddTaskScreen({Key? key, required this.columnTitle, required this.status}) : super(key: key);
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: const Icon(Icons.task, color: Colors.deepPurple), // Icon in the input field
              ),
